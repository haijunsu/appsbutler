...
/**
 * This class provides APIs to encode and decode base64, and you can choose to
 * gzip. Do not break lines while encoding. There are many encoding and decoding
 * APIs from and to byte array, String and file. Please refer to the java doc to
 * get the detail API. <br>
 * <br>
 * Example: <br>
 *
 * <pre>
 ...
 * String encryptedStr = Base64.encodeBytes(buf);
...
public class Base64 {
    ...
    public static String encodeBytes(byte[] source, int off, int len,
        ...
        } else { // Else, don't compress. Better not to use streams at all
            // then.
